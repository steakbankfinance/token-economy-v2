...
contract aSBF is IBEP20, Ownable, IMintBurnToken {
    ...
    */
    ...
    /**
     * @notice Mint the amount of tokens to the sender, increasing the total supply.
     * @dev The amount must be greater than balance, total supply.
     * @param to The number of tokens that are will be minted to
     * @param amount The number of tokens that are will be minted
     * @return true
     */
    function mintTo(address to, uint256 amount) override external onlyOwner returns (bool) {
        _mint(to, amount);
        return true;
    }
